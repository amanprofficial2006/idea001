		...
		<form action="{{ route("admin.categories.update", $category->id) }}" method="POST" enctype="multipart/form-data">
			...
			<div class="mb-4">
				...
				@if ($category->image_url)
					<div class="mb-2">
						<img src="{{ $category->image_url }}" alt="Current Image" class="h-20 w-20 rounded object-cover">
					</div>
				@endif
			...
			<div class="flex justify-end">
				...
				<button type="submit" class="rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700">Update Category</button>
			</div>
		</form>
	</div>
@endsection
